 ...
 */
public class AdapterFindSchoolAcc extends RecyclerView.Adapter<AdapterFindSchoolAcc.MyViewHolder> {
    Context context;
    ...
    public AdapterFindSchoolAcc(Context context, List<InformationFindSchool> data) {
